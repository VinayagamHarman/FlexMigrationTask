...
XMLList.prototype.XMLList_xmlFromProperty = function(r) {
  if (this.XMLList__targetProperty == null || this.XMLList__targetProperty == '*' || (org.apache.royale.utils.Language.is(this.XMLList__targetProperty, QName) && org.apache.royale.utils.Language.as(this.XMLList__targetProperty, QName, true).localName == '*')) {
    return new XML();
  }
  var /** @type {XML} */ ret;
  ...
  ret = new XML();
  ret.setParent(r);
  if (str && str.charAt(0) == '@' || (org.apache.royale.utils.Language.is(this.XMLList__targetProperty, QName) && org.apache.royale.utils.Language.as(this.XMLList__targetProperty, QName, true).isAttribute)) {
...
XMLList.prototype.setChild = function(elementName, elements) {
  ...
  if (idx + '' == elementName + '') {
    ...
    if (idx >= this.XMLList__xmlArray.length) {
      var /** @type {XML} */ xmlR = org.apache.royale.utils.Language.as(r, XML);
      ...
      if (y.nodeKind() != 'attribute') {
        ...
        if (org.apache.royale.utils.Language.is(elements, XML))
          y.setName(org.apache.royale.utils.Language.as(elements, XML).name());
    ...
    if (!(org.apache.royale.utils.Language.is(elements, XML) || org.apache.royale.utils.Language.is(elements, XMLList)) || (org.apache.royale.utils.Language.is(elements, XML) && (org.apache.royale.utils.Language.as(elements, XML).nodeKind() == 'text' || org.apache.royale.utils.Language.as(elements, XML).nodeKind() == 'attribute'))) {
      elements = elements + '';
    }
    if (org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).nodeKind() == 'attribute') {
      var /** @type {QName} */ z = org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).name();
      org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).parent().setAttribute(z, elements);
      var /** @type {XMLList} */ attr = org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).parent().attribute(z);
      this.XMLList__xmlArray[idx] = attr[0];
      this.XMLList_addIndex((idx) >> 0);
    } else if (org.apache.royale.utils.Language.is(elements, XMLList)) {
      var /** @type {XMLList} */ c = new XMLList(elements);
      var /** @type {XML} */ parent = org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).parent();
      if (parent) {
    ...
    } else if (org.apache.royale.utils.Language.is(elements, XML) || org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).nodeKind() == 'text' || org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).nodeKind() == 'comment' || org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).nodeKind() == 'processing-instruction') {
      parent = org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).parent();
      if (parent) {
      ...
      if (typeof(elements) == 'string') {
        ...
        t.setParent(org.apache.royale.utils.Language.as(this, XML));
        t.setValue(elements + '');
      ...
      org.apache.royale.utils.Language.as(this.XMLList__xmlArray[idx], XML).setChild('*', elements);
    }
  } else {
    if (this.XMLList__xmlArray.length <= 1) {
      ...
      org.apache.royale.utils.Language.as(this.XMLList__xmlArray[0], XML).setChild(elementName, elements);
    } else {
