...
org.apache.royale.net.remoting.amf.AMFBinaryData.SerializationContext.prototype.SerializationContext_writeArray = function(v) {
  ...
  if (!this.objectByReference(v)) {
    ...
    var /** @type {Function} */ isFunctionValue = org.apache.royale.utils.Language.closure(this.SerializationContext_isFunctionValue, this, 'SerializationContext_isFunctionValue');
  ...
  switch (amfType) {
    ...
    case org.apache.royale.net.remoting.amf.AMFBinaryData.SerializationContext.AMF3_OBJECT:
      try {
        ...
        if (goog.DEBUG) {
          var /** @type {Error} */ err = (e.message.indexOf("Failed to deserialize") == -1) ? new Error("Failed to deserialize: " + e.message + ' ' + e.stack.split('\n')[1]) : e;
          throw err;
        }
        else
