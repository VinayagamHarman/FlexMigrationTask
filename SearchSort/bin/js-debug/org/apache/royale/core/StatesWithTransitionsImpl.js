...
org.apache.royale.core.StatesWithTransitionsImpl.prototype.org_apache_royale_core_StatesWithTransitionsImpl_stateChangeHandler = function(event) {
  ...
  if (this.org_apache_royale_core_StatesWithTransitionsImpl_transitionEffects && this.org_apache_royale_core_StatesWithTransitionsImpl_transitionEffects.length > 0) {
    ...
    {
      e.addEventListener(org.apache.royale.effects.Effect.EFFECT_END, org.apache.royale.utils.Language.closure(this.org_apache_royale_core_StatesWithTransitionsImpl_effectEndHandler, this, 'org_apache_royale_core_StatesWithTransitionsImpl_effectEndHandler'));
      e.play();
    }}
...
org.apache.royale.core.StatesWithTransitionsImpl.prototype.org_apache_royale_core_StatesWithTransitionsImpl_effectEndHandler = function(event) {
  ...
  for (var /** @type {number} */ i = 0; i < n; i++) {
    event.target.removeEventListener(org.apache.royale.effects.Effect.EFFECT_END, org.apache.royale.utils.Language.closure(this.org_apache_royale_core_StatesWithTransitionsImpl_effectEndHandler, this, 'org_apache_royale_core_StatesWithTransitionsImpl_effectEndHandler'));
...
org.apache.royale.core.StatesWithTransitionsImpl.prototype.org_apache_royale_core_StatesWithTransitionsImpl_apply = function(oldState, s) {
  ...
  var o = foreachiter10_target[foreachiter10];
  {
    if (org.apache.royale.utils.Language.is(o, org.apache.royale.states.AddItems)) {
      ...
      {
        if (!this.org_apache_royale_core_StatesWithTransitionsImpl_isItemInState(item, oldState) || item.parent == null) {
...
org.apache.royale.core.StatesWithTransitionsImpl.prototype.set__strand = function(value) {
  ...
  this.org_apache_royale_core_StatesWithTransitionsImpl__strand.addEventListener("currentStateChange", org.apache.royale.utils.Language.closure(this.org_apache_royale_core_StatesWithTransitionsImpl_stateChangeHandler, this, 'org_apache_royale_core_StatesWithTransitionsImpl_stateChangeHandler'));
  this.org_apache_royale_core_StatesWithTransitionsImpl__strand.addEventListener("initComplete", org.apache.royale.utils.Language.closure(this.org_apache_royale_core_StatesWithTransitionsImpl_initialStateHandler, this, 'org_apache_royale_core_StatesWithTransitionsImpl_initialStateHandler'));
};
