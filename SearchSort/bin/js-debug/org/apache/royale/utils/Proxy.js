...
org.apache.royale.utils.Proxy.prototype.deleteProperty = function(propName) {
  return delete this.org_apache_royale_utils_Proxy_valueMap[propName];
};
  ...
  return {
    methods: function () {
      return {
        ...
        'deleteProperty': { type: 'Boolean', declaredBy: 'org.apache.royale.utils.Proxy', parameters: function () { return [ 'String', false ]; }},
