 ...
 */
goog.exportSymbol('org.apache.royale.textLayout.compose.ParcelList', org.apache.royale.textLayout.compose.ParcelList);
...
org.apache.royale.textLayout.compose.ParcelList.prototype.getLineSlug = function(slug, height, minWidth, textIndent, directionLTR) {
  if (this.currentParcel.getLineSlug(slug, this._totalDepth, height, minWidth, Number(this.currentParcel.fitAny ? 1 : org.apache.royale.utils.Language._int(height)), this._leftMargin, this._rightMargin, textIndent + this._insideListItemMargin, directionLTR, this._explicitLineBreaks)) {
...
org.apache.royale.textLayout.compose.ParcelList.prototype.fitFloat = function(slug, totalDepth, width, height) {
  return this.currentParcel.getLineSlug(slug, totalDepth, height, width, Number(this.currentParcel.fitAny ? 1 : org.apache.royale.utils.Language._int(height)), this._leftMargin, this._rightMargin, 0, true, this._explicitLineBreaks);
};
