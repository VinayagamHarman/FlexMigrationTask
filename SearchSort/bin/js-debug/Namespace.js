...
Namespace.get__xmlNameCheck = function() {
  var value = isXMLName;
  Object.defineProperty(Namespace, 'xmlNameCheck', { value: value, writable: false });
  return value;
};
/**
 * @private
...
Namespace.get__forceLanguageDependency = function() {
  ...
  Object.defineProperty(Namespace, 'forceLanguageDependency', { value: value, writable: true });
  return value;
};
