 ...
 * @override
 */
mx.controls.beads.layouts.DataGridLayout.prototype.setHeaderWidths = function(columnWidths) {
  var /** @type {number} */ ww = 0;
  for (var /** @type {number} */ i = 0; i < columnWidths.length; i++) {
    ww += Number(columnWidths[i]);
  }
  var /** @type {mx.controls.beads.DataGridView} */ view = org.apache.royale.utils.Language.as(this.uiHost.view, mx.controls.beads.DataGridView);
  if (ww > view.listArea.width) {
    if (view.listArea.element.offsetWidth > view.listArea.element.clientWidth) {
      columnWidths[columnWidths.length - 1] += view.listArea.element.offsetWidth - view.listArea.element.clientWidth;
    }
  }
  mx.controls.beads.layouts.DataGridLayout.superClass_.setHeaderWidths.apply(this, [ columnWidths] );
};
...
mx.controls.beads.layouts.DataGridLayout.prototype.layout = function() {
  ...
  if (org.apache.royale.utils.Language.as(this.uiHost, mx.core.ScrollControlBase).horizontalScrollPolicy == mx.core.ScrollPolicy.OFF || totalWidths < useWidth) {
