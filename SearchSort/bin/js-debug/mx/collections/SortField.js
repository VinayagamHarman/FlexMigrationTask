...
mx.collections.SortField.prototype.initializeDefaultCompareFunction = function(obj) {
  if (!this.usingCustomCompareFunction) {
    ...
    if (this.numeric == true)
      this.mx_collections_SortField__compareFunction = org.apache.royale.utils.Language.closure(this.mx_collections_SortField_numericCompare, this, 'mx_collections_SortField_numericCompare');
      ...
      switch (typ) {
        ...
        case "object":
          if (org.apache.royale.utils.Language.is(value, Date)) {
            this.mx_collections_SortField__compareFunction = org.apache.royale.utils.Language.closure(this.mx_collections_SortField_dateCompare, this, 'mx_collections_SortField_dateCompare');
          } else {
            this.mx_collections_SortField__compareFunction = org.apache.royale.utils.Language.closure(this.stringCompare, this, 'stringCompare');
            ...
            if (!test || test == "[object Object]") {
              this.mx_collections_SortField__compareFunction = org.apache.royale.utils.Language.closure(this.mx_collections_SortField_nullCompare, this, 'mx_collections_SortField_nullCompare');
            }
          }
          break;
        case "xml":
...
mx.collections.SortField.prototype.get__arraySortOnOptions = function() {
  ...
  if (this.descending)
    options |= (2) >> 0;
  if (this.numeric == true || this.mx_collections_SortField__compareFunction == org.apache.royale.utils.Language.closure(this.mx_collections_SortField_numericCompare, this, 'mx_collections_SortField_numericCompare'))
    options |= (16) >> 0;
  return options;
};
