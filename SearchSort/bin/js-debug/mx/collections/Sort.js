    ...
    if (this.fields && this.fields.length > 0) {
      ...
      if (this.unique) {
        ...
        if (this.http_$$www_adobe_com$2006$flex$mx$internal__useSortOn && sortArgs && this.fields.length == 1) {
          ...
          uniqueRet2 = org.apache.royale.utils.Language.sort(items, org.apache.royale.utils.Language.closure(this.mx_collections_Sort_internalCompare, this, 'mx_collections_Sort_internalCompare'), 4);
        }
        if (uniqueRet2 == 0) {
          message = "nonUnique";
          throw new mx.collections.errors.SortError(message);
        ...
        if (this.http_$$www_adobe_com$2006$flex$mx$internal__useSortOn && sortArgs) {
          ...
          items.sort(org.apache.royale.utils.Language.closure(this.mx_collections_Sort_internalCompare, this, 'mx_collections_Sort_internalCompare'));
        }
      }
    } else {
      items.sort(org.apache.royale.utils.Language.closure(this.mx_collections_Sort_internalCompare, this, 'mx_collections_Sort_internalCompare'));
...
mx.collections.Sort.prototype.get__compareFunction = function() {
  return this.mx_collections_Sort_usingCustomCompareFunction ? this.mx_collections_Sort__compareFunction : org.apache.royale.utils.Language.closure(this.mx_collections_Sort_internalCompare, this, 'mx_collections_Sort_internalCompare');
};
