...
mx.collections.ListCollectionView.prototype.set__list = function(value) {
  if (this.mx_collections_ListCollectionView__list != value) {
    ...
    if (this.mx_collections_ListCollectionView__list) {
      this.mx_collections_ListCollectionView__list.removeEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, org.apache.royale.utils.Language.closure(this.mx_collections_ListCollectionView_listChangeHandler, this, 'mx_collections_ListCollectionView_listChangeHandler'));
      oldHasItems = this.mx_collections_ListCollectionView__list.length > 0;
    }
    this.mx_collections_ListCollectionView__list = value;
    if (this.mx_collections_ListCollectionView__list) {
      this.mx_collections_ListCollectionView__list.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, org.apache.royale.utils.Language.closure(this.mx_collections_ListCollectionView_listChangeHandler, this, 'mx_collections_ListCollectionView_listChangeHandler'), false);
...
mx.collections.ListCollectionView.ListCollectionViewCursor = function(view) {
  ...
  this.ListCollectionViewCursor__view.addEventListener(mx.events.CollectionEvent.COLLECTION_CHANGE, org.apache.royale.utils.Language.closure(this.ListCollectionViewCursor_collectionEventHandler, this, 'ListCollectionViewCursor_collectionEventHandler'));
