...
mx.managers.SystemManager.prototype.mx_managers_SystemManager_initializeTopLevelWindow = function(event) {
  ...
  this.mxmlDocument.addEventListener("applicationComplete", org.apache.royale.utils.Language.closure(this.mx_managers_SystemManager_applicationCompleteHandler, this, 'mx_managers_SystemManager_applicationCompleteHandler'));
  ...
  window.addEventListener('resize', org.apache.royale.utils.Language.closure(this.mx_managers_SystemManager_resizeHandler, this, 'mx_managers_SystemManager_resizeHandler'), false);
};
