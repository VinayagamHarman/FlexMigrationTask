...
mx.events.KeyboardEvent.prototype.get__charCode = function() {
  if (this.code == "Enter")
    return 13;
...
/**
  ...
  * @type {number} */
charCode: {
get: mx.events.KeyboardEvent.prototype.get__charCode}}
);
  ...
  return {
    accessors: function () {
      return {
        ...
        'charCode': { type: 'uint', access: 'readonly', declaredBy: 'mx.events.KeyboardEvent'}
      };
    },
    methods: function () {
      return {
