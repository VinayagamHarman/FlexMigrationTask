...
mx.events.FocusEvent = function(type, bubbles, cancelable, relatedObject, shiftKey, keyCode, direction) {
  ...
  this.mx_events_FocusEvent__relatedObject = relatedObject;
};
 ...
 * @type {Object}
 */
mx.events.FocusEvent.prototype.mx_events_FocusEvent__relatedObject;
...
mx.events.FocusEvent.prototype.wrapEvent = function(event) {
  this.mx_events_FocusEvent_nativeEvent = event;
};


mx.events.FocusEvent.prototype.get__relatedObject = function() {
  if (this.mx_events_FocusEvent_nativeEvent && this.mx_events_FocusEvent_nativeEvent["relatedTarget"]) {
    return this.mx_events_FocusEvent_nativeEvent["relatedTarget"].royale_wrapper;
  }
  return this.mx_events_FocusEvent__relatedObject;
};


Object.defineProperties(mx.events.FocusEvent.prototype, /** @lends {mx.events.FocusEvent.prototype} */ {
/**
  * @export
  * @type {Object} */
relatedObject: {
get: mx.events.FocusEvent.prototype.get__relatedObject}}
);
...
mx.events.FocusEvent.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    accessors: function () {
      return {
        'relatedObject': { type: 'Object', access: 'readonly', declaredBy: 'mx.events.FocusEvent'}
      };
    },
    methods: function () {
      return {
        ...
        'wrapEvent': { type: 'void', declaredBy: 'mx.events.FocusEvent', parameters: function () { return [ 'Object', false ]; }}
      };
    }
  };
};
