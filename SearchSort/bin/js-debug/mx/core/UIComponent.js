...
/* Royale Dependency List: mx.controls.beads.ToolTipBead,mx.core.FlexCSSStyles,mx.core.FlexGlobals,mx.core.IFlexModuleFactory,mx.core.LayoutElementUIComponentUtils,mx.core.UITextFormat,mx.core.mx_internal,mx.display.Graphics,mx.events.FlexEvent,mx.events.FocusEvent,mx.events.KeyboardEvent,mx.events.PropertyChangeEvent,mx.events.ValidationResultEvent,mx.managers.ICursorManager,mx.managers.IFocusManager,mx.managers.IFocusManagerComponent,mx.managers.IFocusManagerContainer,mx.managers.ISystemManager,mx.resources.IResourceManager,mx.resources.ResourceManager,mx.styles.IStyleManager2,mx.styles.StyleManager,mx.validators.ValidationResult,org.apache.royale.core.CallLaterBead,org.apache.royale.core.IBorderPaddingMarginValuesImpl,org.apache.royale.core.IChild,org.apache.royale.core.IStatesImpl,org.apache.royale.core.IUIBase,org.apache.royale.core.TextLineMetrics,org.apache.royale.core.ValuesManager,org.apache.royale.core.styles.BorderStyles,org.apache.royale.effects.IEffect,org.apache.royale.events.Event,org.apache.royale.events.IEventDispatcher,org.apache.royale.events.MouseEvent,org.apache.royale.events.ValueChangeEvent,org.apache.royale.geom.Point,org.apache.royale.geom.Rectangle,org.apache.royale.html.beads.DisableBead,org.apache.royale.html.beads.DisabledAlphaBead,org.apache.royale.html.supportClasses.ContainerContentArea,org.apache.royale.utils.CSSUtils,org.apache.royale.utils.MXMLDataInterpreter,org.apache.royale.utils.PointUtils,org.apache.royale.utils.loadBeadFromValuesManager,org.apache.royale.utils.Language,XML*/
...
mx.core.UIComponent = function() {
  ...
  if (org.apache.royale.utils.Language.is(this, mx.managers.IFocusManagerComponent)) {
    
    this.addEventListener(mx.events.FocusEvent.FOCUS_IN, org.apache.royale.utils.Language.closure(this.focusInHandler, this, 'focusInHandler'));
    this.addEventListener(mx.events.FocusEvent.FOCUS_OUT, org.apache.royale.utils.Language.closure(this.focusOutHandler, this, 'focusOutHandler'));
    this.addEventListener(mx.events.KeyboardEvent.KEY_DOWN, org.apache.royale.utils.Language.closure(this.keyDownHandler, this, 'keyDownHandler'));
    this.addEventListener(mx.events.KeyboardEvent.KEY_UP, org.apache.royale.utils.Language.closure(this.keyUpHandler, this, 'keyUpHandler'));
  }
};
 ...
 * @type {number}
 */
mx.core.UIComponent.prototype.mx_core_UIComponent__index = 0;
...
mx.core.UIComponent.prototype.createChildren = function() {
  org.apache.royale.utils.MXMLDataInterpreter.generateMXMLInstances(this.mxmlDocument, this, this.MXMLDescriptor);
};
 ...
 *  @productversion Flex 3
 * @export
 * @param {mx.events.FocusEvent} event
 */
mx.core.UIComponent.prototype.focusInHandler = function(event) {
};
 ...
 * @param {mx.events.FocusEvent} event
 */
mx.core.UIComponent.prototype.focusOutHandler = function(event) {
};
...
mx.core.UIComponent.prototype.owns = function(child) {
  if (!org.apache.royale.utils.Language.is(child, org.apache.royale.core.IUIBase))
    return false;
  return this.contains(org.apache.royale.utils.Language.as(child, org.apache.royale.core.IUIBase));
};
...
mx.core.UIComponent.prototype.setVisible = function(value) {
  ...
  if (Boolean(value) !== oldValue) {
    if (!value) {
      ...
      this.positioner.style.visibility = null;
    }
  }
...
mx.core.UIComponent.prototype.get__index = function() {
  return this.mx_core_UIComponent__index;
};


mx.core.UIComponent.prototype.set__index = function(value) {
  this.mx_core_UIComponent__index = value;
};
...
mx.core.UIComponent.prototype.set__currentState = function(value) {
  ...
  this.addEventListener("stateChangeComplete", org.apache.royale.utils.Language.closure(this.mx_core_UIComponent_stateChangeCompleteHandler, this, 'mx_core_UIComponent_stateChangeCompleteHandler'));
...
mx.core.UIComponent.prototype.get__screen = function() {
  ...
  var /** @type {org.apache.royale.core.IUIBase} */ topLevelApplication = org.apache.royale.utils.Language.as(mx.core.FlexGlobals.topLevelApplication, org.apache.royale.core.IUIBase);
  return new org.apache.royale.geom.Rectangle(0, 0, topLevelApplication.width, topLevelApplication.height);
};
...
mx.core.UIComponent.prototype.get__visible = function() {
  if (!this.positioner.style.visibility)
    return true;
  return this.positioner.style.visibility != 'hidden';
};
...
/**
  ...
  * @type {number} */
index: {
get: mx.core.UIComponent.prototype.get__index,
set: mx.core.UIComponent.prototype.set__index},
/**
  * @export
  * @type {number} */
chromeColor: {
 ...
 */
mx.core.UIComponent.prototype.ROYALE_CLASS_INFO = { names: [{ name: 'UIComponent', qName: 'mx.core.UIComponent', kind: 'class' }], interfaces: [mx.core.IChildList, mx.core.IFlexDisplayObject, org.apache.royale.core.IMXMLDocument, mx.core.IInvalidating, org.apache.royale.core.IStatesObject, mx.styles.ISimpleStyleClient, mx.core.IUIComponent, mx.core.IVisualElement, mx.core.IFlexModule, mx.validators.IValidatorListener] };
  ...
  return {
    ...
    accessors: function () {
      return {
        ...
        'index': { type: 'int', access: 'readwrite', declaredBy: 'mx.core.UIComponent'},
        ...
        'enabled': { type: 'Boolean', access: 'readwrite', declaredBy: 'mx.core.UIComponent', metadata: function () { return [ { name: 'Bindable', args: [ { key: '', value: 'disabledChange' } ] } ]; }},
    ...
    methods: function () {
      return {
        ...
        'contains': { type: 'Boolean', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ 'org.apache.royale.core.IUIBase', false ]; }},
        ...
        'owns': { type: 'Boolean', declaredBy: 'mx.core.UIComponent', parameters: function () { return [ 'org.apache.royale.core.IUIBase', false ]; }},
